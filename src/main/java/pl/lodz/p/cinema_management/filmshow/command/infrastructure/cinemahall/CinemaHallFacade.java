package pl.lodz.p.cinema_management.filmshow.command.infrastructure.cinemahall;
...
import pl.lodz.p.cinema_management.filmshow.command.application.CinemaHallService;
...
public class CinemaHallFacade implements CinemaHallService {
    ...
    @Override
    public pl.lodz.p.cinema_management.filmshow.command.domain.CinemaHall getCinemaHallById(Integer id) {
