...
import pl.lodz.p.cinema_management.reservation.command.application.AuthenticationService;
...
public class AuthenticationFacade implements AuthenticationService {
    ...
    @Override
    public pl.lodz.p.cinema_management.reservation.command.domain.User getLoggedInUser() {
